...
public class TextureManager {
     ...
     */
    public static void drawClippedTexture(DrawContext context, Identifier texture, float x, float y, float width, float height,
                                          float clipX, float clipY, float clipWidth, float clipHeight) {
        // Skip if texture would be entirely outside clip bounds
